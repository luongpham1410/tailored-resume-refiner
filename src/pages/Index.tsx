...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#221F26] to-[#403E43]">
      <div className="container max-w-4xl py-12">
        <div className="glass-card rounded-xl p-8 mb-8 text-center animate-fade-in bg-[#222222]/90 backdrop-blur-sm border border-[#0EA5E9]/20 shadow-lg">
          <h1 className="text-3xl font-semibold mb-6 text-[#0EA5E9]">Resume Analysis</h1>
          <div className="flex flex-col items-center gap-4">
            <ScoreCircle score={overallScore} />
            <div className="text-2xl font-bold text-[#0EA5E9]">Grade: {letterGrade}</div>
          </div>
          <p className="mt-4 text-[#33C3F0]/90">
